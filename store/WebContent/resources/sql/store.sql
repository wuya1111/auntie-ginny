...
insert into store_copy (STORE_COPY_ID, COPY_NAME, COPY_BODY, COPY_LINK, COPY_LINK_TEXT, COPY_IMAGE, COPY_IMAGE_ALT_TEXT, COPY_TYPE, COPY_ORDER, START_DATE, END_DATE, STORE_ID) values (5,'Featurette Copy Two'  ,'<h2 class="featurette-heading">Second featurette heading. <span class="text-muted">It\'ll blow your mind.</span></h2><p class="lead">This is the featurette copy body for copy test two.</p>' ,'link-two'  ,'See details Two &raquo;'   ,'featurette-two.png',     'image two alt text'  ,'featurette',5,'2017-01-01 00:00:01','2020-01-01 00:00:01',1);
insert into store_copy (STORE_COPY_ID, COPY_NAME, COPY_BODY, COPY_LINK, COPY_LINK_TEXT, COPY_IMAGE, COPY_IMAGE_ALT_TEXT, COPY_TYPE, COPY_ORDER, START_DATE, END_DATE, STORE_ID) values (6,'Featurette Copy Three','<h2 class="featurette-heading">Third featurette heading. <span class="text-muted">It\'ll blow your mind.</span></h2><p class="lead">This is the featurette copy body for copy test three.</p>','link-three','See details Three &raquo;' ,'featurette-three.png',   'image three alt text','featurette',6,'2017-01-01 00:00:01','2020-01-01 00:00:01',1);
